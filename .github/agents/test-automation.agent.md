...
| Skill | Domain |
|-------|--------|
| `test-automation-engineer` | All UI test-automation domains — compact core + lazy `references/<domain>/` (playwright-best-practices, playwright-test-creator, playwright-cli, playwright-mcp, browserstack, webapp-testing) |
