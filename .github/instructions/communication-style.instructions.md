---
description: 'Always-on communication style: use the caveman skill for token-efficient responses. Use when: any user-facing reply, be brief, less tokens.'
applyTo: '**'
---

# Communication Style

- **First routing rule:** Before any user-facing answer, consider `.github/skills/caveman/SKILL.md` first and apply `caveman` unless the user explicitly says `stop caveman` or `normal mode`.
- Use the `caveman` skill for every user-facing response — cuts token usage while keeping full technical accuracy.
