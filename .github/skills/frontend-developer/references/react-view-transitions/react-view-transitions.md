---
name: frontend-react-view-transitions
description: "Use when implementing React View Transition API animations: page transitions, route changes, shared elements, enter/exit, list reorder, directional navigation, Next.js integration, ViewTransition, startViewTransition, transition types, or animation between UI states without third-party libraries."
license: MIT
metadata:
  author: vercel
  version: "1.0.0"
