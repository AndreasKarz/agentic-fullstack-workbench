---
name: frontend-relay-best-practices
description: "Use when writing, modifying, reviewing, or debugging React Relay code. Triggers on: useFragment, useLazyLoadQuery, usePreloadedQuery, useMutation, usePaginationFragment, graphql literals, react-relay imports, generated Relay types, fragments, queries, mutations, pagination."
---
...
`frontend-relay-performance` skill.
