---
name: frontend-copilotkit-react-core
description: "Use when building CopilotKit React UI with @copilotkit/react-core/v2: provider setup, CopilotChat/CopilotPopup/CopilotSidebar, useAgent, useFrontendTool, useRenderTool, human-in-the-loop, attachments, suggestions, threads, and custom renderers."
type: framework
library: copilotkit
