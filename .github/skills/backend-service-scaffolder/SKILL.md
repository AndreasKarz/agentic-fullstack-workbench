---
name: backend-service-scaffolder
description: "Scaffold a new .NET microservice end-to-end — create Abstractions, Core, DataAccess, GraphQL, Host, Worker projects with correct layer dependencies, DI wiring, health checks, and test projects. Triggers on: new service, new microservice, scaffold service, create service, add domain service, new domain, setup service skeleton."
---

# Service Scaffolder

Scaffold a complete .NET domain microservice following the established project structure and conventions.
...
namespace YourCompany.YourProduct.{ServiceName}.DataAccess;
...
namespace YourCompany.YourProduct.{ServiceName}.GraphQL;
...
```csharp
// Startup.cs
namespace YourCompany.YourProduct.{ServiceName}.Host;
