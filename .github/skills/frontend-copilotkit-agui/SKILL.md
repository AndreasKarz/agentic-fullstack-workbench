...
- For CopilotKit React hooks and frontend components, use `frontend-copilotkit-develop`
- For CopilotKit runtime setup and configuration, use `frontend-copilotkit-setup` or `frontend-copilotkit-runtime`
- For framework-specific integration guides (LangGraph, Mastra, CrewAI), use `frontend-copilotkit-integrations`
