---
name: frontend-copilotkit-a2ui-renderer
description: "Use when rendering CopilotKit A2UI declarative surfaces: createSurface, updateComponents, updateDataModel, CopilotRuntime a2ui config, CopilotKit a2ui provider prop, createA2UIMessageRenderer, themes, and action bridge cleanup."
type: framework
library: copilotkit
framework: react
library_version: "1.56.2"
requires:
  - frontend-copilotkit-react-core
...
This skill builds on `frontend-copilotkit-react-core` for `CopilotKit` provider fundamentals and
`frontend-copilotkit-runtime` for CopilotRuntime fundamentals. Read those first.
