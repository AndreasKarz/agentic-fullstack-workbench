---
name: frontend-copilotkit-runtime
description: "Use when building CopilotKit server runtime with @copilotkit/runtime/v2: CopilotRuntime, createCopilotRuntimeHandler, BuiltInAgent, AgentRunner, Intelligence mode, middleware, server-side tools, transcription, and external agent wiring."
type: core
library: copilotkit
...
new CopilotRuntime({
  ...
  a2ui, // A2UIConfig (optional)             — see copilotkit-a2ui-renderer skill
