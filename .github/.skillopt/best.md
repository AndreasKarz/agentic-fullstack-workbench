...
| CopilotKit | `frontend-copilotkit-setup`, `frontend-copilotkit-develop`, `frontend-copilotkit-debug`, `frontend-copilotkit-runtime`, `frontend-copilotkit-react-core`, `frontend-copilotkit-a2ui-renderer`, `frontend-copilotkit-agui`, `frontend-copilotkit-integrations`, `frontend-copilotkit-upgrade`, `frontend-copilotkit-contribute`, `frontend-copilotkit-self-update` |
